...
public class ProjectDetailVo implements Serializable {
    ...
    public ProjectDetailVo(Integer memberid, Integer id, String name, String remark, Long money, Integer day, String status, String deploydate, Long supportmoney, Integer supporter, Integer completion, Integer follower, String headerImage, List<String> detailsImage, List<ProjectReturnVo> projectReturns) {
    ...
    public List<ProjectReturnVo> getProjectReturns() {
        return projectReturns;
    }

    public void setProjectReturns(List<ProjectReturnVo> projectReturns) {
        this.projectReturns = projectReturns;
    }
}
